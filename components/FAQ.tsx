  ...
  return (
    <section id="faq" className="py-16 px-4 bg-gray-100">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8">YouTube to MP3 Converter FAQ</h2>
        <div className="space-y-6">
          <div>
            ...
            <p>
              ...
              file. Our YouTube to MP3 converter works with all types of YouTube videos.
            </p>
          </div>
          <div>
